...
/**
 * Panel para mostrar el reporte mensual de socios adultos
 */
public class ReporteMensualAdultosPanel extends JPanel {
     ...
     */
    public ReporteMensualAdultosPanel(MenuPrincipal menuPrincipal) {
    ...
    private void inicializarComponentes() {
        ...
        lblTitulo = new JLabel("Reporte Mensual de Socios Adultos");
    ...
    private void generarReporte() {
        ...
        try {
            // Consulta SQL para obtener los movimientos del mes para socios adultos
            ...
            lblTitulo.setText("Reporte Mensual de Socios Adultos - " + mesTexto + " " + anio);
    ...
    private void imprimirReporte() {
        try {
            ...
            int anio = Integer.parseInt(cboAnio.getSelectedItem().toString());
            String mesTexto = cboMes.getSelectedItem().toString().substring(5); // Obtener la parte del nombre del mes            // Obtener texto de los totales para incluirlos en el encabezado
            ...
            String headerText = "Reporte Mensual de Socios Adultos - " + mesTexto + " " + anio + 
