...
/**
 * Panel para mostrar el reporte anual de socios infantiles
 */
public class ReporteAnualInfantesPanel extends JPanel {
     ...
     */
    public ReporteAnualInfantesPanel(MenuPrincipal menuPrincipal) {
    ...
    private void inicializarComponentes() {
        ...
        lblTitulo = new JLabel("Reporte Anual de Socios Infantiles");
        ...
        btnImprimirIngresos.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                imprimirTabla(tablaIngresos, "Ingresos Anuales - Socios Infantiles");
            }
        });
        ...
        btnImprimirEgresos.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                imprimirTabla(tablaEgresos, "Egresos Anuales - Socios Infantiles");
            }
        });
    ...
    private void generarReporte() {
        ...
        lblTitulo.setText("Reporte Anual de Socios Infantiles - " + anio);
        
        try {            // Consulta para obtener los ingresos mensuales
            String consultaIngresos = "SELECT MONTH(Fecha) as Mes, " +
                         ...
                         "WHERE YEAR(Fecha) = ? AND (TipoSocio = 'INFANTIL' OR TipoSocio = 'INFANTE') " +
