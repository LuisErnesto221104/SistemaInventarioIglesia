...
public class Conexion {    
    ...
    public Conexion(){
        try {
            ...
            String ruta = directorioActual + File.separator + "database" + File.separator + "dbcaja.mdb"; // Ruta absoluta de la base de datos Access            // Verificar si el archivo de la BD existe
