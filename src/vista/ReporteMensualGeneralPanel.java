...
/**
 * Panel para mostrar el reporte mensual general
 */
public class ReporteMensualGeneralPanel extends JPanel {
     ...
     */
    public ReporteMensualGeneralPanel(MenuPrincipal menuPrincipal) {
    ...
    private void inicializarComponentes() {
        ...
        lblTitulo = new JLabel("Reporte Mensual General");
        ...
        String[] columnas = {"Fecha", "TipoSocio", "Aportaciones", "Abonos", "Intereses", "Ahorros",
        ...
        modeloTabla = new DefaultTableModel(columnas, 0) {
            ...
            public Class<?> getColumnClass(int columnIndex) {
                if (columnIndex >= 2) return Double.class; // Columnas numéricas
                return String.class;
            }
        };
        ...
        for (int i = 2; i < tablaReporte.getColumnCount(); i++) {
        ...
        tablaReporte.getColumnModel().getColumn(1).setPreferredWidth(80); // TipoSocio
    ...
    private void generarReporte() {
        ...
        try {
            // Consulta SQL para obtener los movimientos del mes para todos los socios
            String consulta = "SELECT ms.Fecha, ms.TipoSocio, " +
                         ...
                         "GROUP BY ms.Fecha, ms.TipoSocio " +
                         "ORDER BY ms.Fecha, ms.TipoSocio";
            ...
            lblTitulo.setText("Reporte Mensual General - " + mesTexto + " " + anio);
    ...
    private void imprimirReporte() {
        try {
            ...
            MessageFormat header = new MessageFormat("Reporte Mensual General - " + mesTexto + " " + anio);
