 ...
 */
public class MovimientoSocio extends JPanel {
     ...
     */
    public MovimientoSocio(MenuPrincipal menuPrincipal) {
     ...
     */    
    private void crearPanelInfoSocio() {        
        
        panelInfoSocio = new JPanel(new GridLayout(3, 2, 20, 12)); // Aún más espacio entre elementos
    ...
    private void crearPanelTablaMovimientos() {
        panelMovimientos = new JPanel(new BorderLayout(30, 15)); // Agregamos espaciado
        ...
        modeloTabla.addColumn("EGR. PRE.");  // Prestaciones - Egresos
        modeloTabla.addColumn("ING. PRE."); // Prestaciones - Ingresos/Abonos
        modeloTabla.addColumn("SALDO PRE.");    // Prestaciones - Saldo
        
        // Columna para Intereses
        modeloTabla.addColumn("INTERÉS");
        
        // Columnas para Ahorros
        modeloTabla.addColumn("ING. AHO"); // Ahorros - Ingresos
        modeloTabla.addColumn("EGR. AHO");  // Ahorros - Egresos
        modeloTabla.addColumn("SALDO AHO");    // Ahorros - Saldo
        ...
        tablaMovimientos.setPreferredScrollableViewportSize(new Dimension(1200, 400)); // Tamaño 
        tablaMovimientos.setFillsViewportHeight(true);
        tablaMovimientos.setRowHeight(38); // Altura filas
        tablaMovimientos.setFont(new Font("Arial", Font.PLAIN, 14)); // Fuente 
        tablaMovimientos.getTableHeader().setFont(new Font("Arial", Font.BOLD, 14));
        tablaMovimientos.getTableHeader().setPreferredSize(new Dimension(0, 42)); // Altura cabecera
        tablaMovimientos.setShowGrid(true);
            tablaMovimientos.setGridColor(new Color(180, 180, 180)); // Grid visible, color oscuro
        ...
        tablaMovimientos.getColumnModel().getColumn(0).setPreferredWidth(80); // Fecha
        ...
        tablaMovimientos.getColumnModel().getColumn(4).setPreferredWidth(70); // Egresos
        tablaMovimientos.getColumnModel().getColumn(5).setPreferredWidth(100); // Ingresos/Abonos
        ...
        panelCategorias.add(lblAhorros); //panel de instrucciones 
        JPanel panelInstrucciones = new JPanel(new FlowLayout(FlowLayout.LEFT, 10, 5));
        panelInstrucciones.setBackground(new Color(255, 248, 220)); // Amarillo crema 
    ...
    private void crearPanelIntereses() {
        ...
        for (int i = 1; i <= 20; i++) { // Limitamos a 20 semanas
    ...
    private void crearPanelAuxiliarCobro() {
        ...
        // Panel para total del movimiento 
        ...
        txtTotalMovimiento.setBackground(new Color(255, 200, 200)); // Fondo rojo claro para destacar
        txtTotalMovimiento.setFont(new Font("Arial", Font.BOLD, 14));
        panelTotal.add(lblTotal);
        panelTotal.add(txtTotalMovimiento);
        
        // Panel para cantidad recibida 
