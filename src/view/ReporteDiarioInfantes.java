...
/**
 * P            // Mejorar el manejo de página final y márgenes para la impresión
            ...
            tablaReporte.setFont(originalFont);strar el reporte diario de socios infantiles
 */
public class ReporteDiarioInfantes extends JPanel {
     ...
     */
    public ReporteDiarioInfantes(MenuPrincipal menuPrincipal) {
    ...
    private void imprimirReporte() {
        try {
            ...
            // Obtener fecha seleccionada para mostrar en título
            Calendar cal = Calendar.getInstance();
            cal.set(anio, mes, dia);
            ...
            String headerText = "Reporte Diario de Socios Infantiles - " + fechaFormateada + 
