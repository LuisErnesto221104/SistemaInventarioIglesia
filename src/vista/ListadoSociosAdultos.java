...
/**
 * ListadoSociosAdultos
 * Ventana que muestra el listado de socios adultos
 */
public class ListadoSociosAdultos extends JFrame {
    ...
    private void inicializarComponentes() {
        setTitle("Listado de Socios Adultos");
        setSize(900, 600);
        ...
        JLabel lblContador = new JLabel("Total: 0 registros");
      ...
      private void cargarDatos() {
        ...
        java.util.List<Map<String, Object>> listaSocios = socioDAO.listarSocios();
    ...
    private void imprimirDatos() {
        try {
            MessageFormat encabezado = new MessageFormat("Listado de Socios Adultos");
