...
/**
 * Panel para mostrar el reporte anual general (adultos e infantiles)
 */
public class ReporteAnualGeneralPanel extends JPanel {
     ...
     */
    public ReporteAnualGeneralPanel(MenuPrincipal menuPrincipal) {
    ...
    private void inicializarComponentes() {
        ...
        lblTitulo = new JLabel("Reporte Anual General");
        ...
        btnImprimirIngresos.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                imprimirTabla(tablaIngresos, "Ingresos Anuales - General");
            }
        });
        ...
        btnImprimirEgresos.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                imprimirTabla(tablaEgresos, "Egresos Anuales - General");
            }
        });
    ...
    private void generarReporte() {
        ...
        lblTitulo.setText("Reporte Anual General - " + anio);
